...
var testWithServersFlexConnector = [
  {
    ...
    name: 'wrong endpoint',
    topic: '',
    payload: '{"discoveryUrl":null,"endpoint":"localhost:52189","keepSessionAlive":false,"securityPolicy":"None","securityMode":"NONE","name":"LOCAL FLEXIBLE INJECTED SERVER","showErrors":true,"publicCertificateFile":null,"privateKeyFile":null,"defaultSecureTokenLifetime":0,"endpointMustExist":false,"autoSelectRightEndpoint":false,"strategyMaxRetry":0,"strategyInitialDelay":0,"strategyMaxDelay":0,"strategyRandomisationFactor":0,"requestedSessionTimeout":0,"connectionStartDelay":0,"reconnectDelay":0}',
    payloadType: 'json',
    repeat: '',
    crontab: '',
    once: true,
  ...
  },
  {
    ...
    name: '89',
    topic: '',
    payload: '{"discoveryUrl":null,"endpoint":"opc.tcp://localhost:52189/","keepSessionAlive":false,"securityPolicy":"None","securityMode":"NONE","name":"LOCAL FLEXIBLE INJECTED SERVER","showErrors":true,"publicCertificateFile":null,"privateKeyFile":null,"defaultSecureTokenLifetime":0,"endpointMustExist":false,"autoSelectRightEndpoint":false,"strategyMaxRetry":0,"strategyInitialDelay":0,"strategyMaxDelay":0,"strategyRandomisationFactor":0,"requestedSessionTimeout":0,"connectionStartDelay":0,"reconnectDelay":0}',
    payloadType: 'json',
    repeat: '',
    crontab: '',
    once: true,
  ...
  },
  {
    ...
    name: '87',
    topic: '',
    payload: '{"discoveryUrl":null,"endpoint":"opc.tcp://localhost:52187/","keepSessionAlive":false,"securityPolicy":"None","securityMode":"NONE","name":"LOCAL FLEXIBLE INJECTED SERVER","showErrors":true,"publicCertificateFile":null,"privateKeyFile":null,"defaultSecureTokenLifetime":0,"endpointMustExist":false,"autoSelectRightEndpoint":false,"strategyMaxRetry":0,"strategyInitialDelay":0,"strategyMaxDelay":0,"strategyRandomisationFactor":0,"requestedSessionTimeout":0,"connectionStartDelay":0,"reconnectDelay":0}',
    payloadType: 'json',
    repeat: '',
    crontab: '',
    once: true,
  ...
  describe('Flex Connector node', function () {
    it('should be loaded and get five injects', function (done) {
      helper.load(flexConnectorNodes, testFlexConnectorFlow,
        function () {
          let counter = 0
          const nodeUnderTest = helper.getNode('n1fc')
    ...
    it('should be loaded with connector, inject, and servers', function (done) {
      helper.load(flexConnectorNodes, testWithServersFlexConnector,
        function () {
          let counter = 0
          const nodeUnderTest = helper.getNode('n2fcs')
          expect(nodeUnderTest).toBeDefined()
          nodeUnderTest.on('input', (msg) => {
            counter++
            expect(msg.payload).toBeDefined()
    ...
    it('should be loaded with listener, events, and servers', function (done) {
      helper.load(flexConnectorNodes, flexConnectorSwitchingEndpointWithListenerFlow,
        function () {
          let counter = 0
          const nodeUnderTest = helper.getNode('n1rcf1')
          expect(nodeUnderTest).toBeDefined()
          nodeUnderTest.on('input', (msg) => {
            counter++
            expect(msg.payload).toBeDefined()
