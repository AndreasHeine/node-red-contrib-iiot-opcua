  ...
  describe('Node node', function () {
    it('should be loaded', function (done) {
      helper.load(
        ...
        function () {
          const nodeUnderTest = helper.getNode('3a234e92.cbc0f2')
